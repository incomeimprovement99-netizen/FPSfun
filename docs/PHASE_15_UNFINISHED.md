...
11. Then down `docs/NEXT_STEPS.md`: the Gulag, emotes, then the loading screen and LOD. (Spectating your squad already works; the dropship, the Ring Console and Resurgence are done.)
