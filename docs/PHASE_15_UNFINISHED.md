...
11. Then down `docs/NEXT_STEPS.md`: emotes, then LOD and draw distance. (Spectating your squad already works; the dropship, the Ring Console, Resurgence, the Gulag and the loading screen are done.)
