...
| 3 | **Body variety: head shapes, and silhouettes that differ** | Half done. The three **builds** shipped with the picker, and they change the clothes rather than the body on purpose: hit boxes must not move. What is still open is the part clothes cannot fix. Eight of the ten sets wear the same six garments in a different colour, so they read as one silhouette; and every head is the same head. Wanted: a hood, a ghillie's rags, a sleeveless carrier, a second head shape. | half a day |
