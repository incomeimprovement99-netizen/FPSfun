...
|---|---|---|
| `concrete/` | ambientCG Concrete048 (CC0) | range floor, clean light concrete |
| `wall/` | ambientCG Metal049A (CC0) | bay walls and dividers, clean silver metal |
| `catwalk/` | ambientCG Metal050A (CC0) | platforms and stairs, brushed aluminium |
| `panel/` | ambientCG Metal041A (CC0) | cover, posts and target frames, clean iron |
| `ground/` | ambientCG Asphalt031 (CC0) | outside the pad, light asphalt |
| `sand/` | ambientCG Ground037 (CC0) | Outskirts' floor, dry packed sand |
| `rock/` | ambientCG Rock030 (CC0) | the ridge, the mesas and the boulders |
| `gravel/` | ambientCG Gravel023 (CC0) | yards and the roadside |
| `corrugated/` | ambientCG CorrugatedSteel005 (CC0) | North Yard's sheds and warehouse |
| `rust/` | ambientCG Rust004 (CC0) | South Depot: industrial, weathered |
| `plaster/` | ambientCG PaintedPlaster017 (CC0) | West Town's houses |
| `brick/` | ambientCG Bricks066 (CC0) | the Hub's compound walls |
...
| `sky-afternoon.hdr` | Poly Haven qwantani_late_afternoon_puresky (CC0) | low warm sun |
| `sky-dusk.hdr` | Poly Haven qwantani_dusk_1_puresky (CC0) | dusk, the lamps start to matter |
| `sky-overcast.hdr` | Poly Haven kloofendal_overcast_puresky (CC0) | flat grey, no shadows to read |
| `sky-night.hdr` | Poly Haven qwantani_moon_noon_puresky (CC0) | moonlight, for the night variant |
