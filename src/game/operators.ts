...
export interface OperatorSkin {
  ...
  sleeve: number;
  cuff: number;
  extras: { crest?: boolean; antenna?: boolean; shoulders?: boolean; brim?: boolean; mask?: boolean };
}
...
export const OPERATORS: OperatorSkin[] = [
  ...
  },
  {
    ...
    extras: { antenna: true, shoulders: true },
  },
];
